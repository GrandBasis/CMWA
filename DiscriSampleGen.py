...
def parse_args():
    ...
    parser.add_argument('--exp_tag', type=str, default="output", help='Unique experiment identifier used to create results directory.')
...
if __name__ == "__main__":
    ...
    print('Start to generate discriminative samples......')
